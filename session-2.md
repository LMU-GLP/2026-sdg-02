...
5. GitHub asks whether Claude can access your account. Press the green
   **Authorize** button
6. Back in the repo list, search for `2026-sdg-02` and click
   **LMU-GLP/2026-sdg-02**

**Repo not in the list?** You haven't accepted the invitation to it yet. Open
**[github.com/LMU-GLP/2026-sdg-02/invitations](https://github.com/LMU-GLP/2026-sdg-02/invitations)**
...
[github.com/LMU-GLP/2026-sdg-02](https://github.com/LMU-GLP/2026-sdg-02).
...
```
Set up this repo as an LLM wiki for our challenge: "How might we help more families access healthy, affordable food in their community?"
...
https://sdgs.un.org/goals/goal2, one dataset with real figures, and one
...
[your repo](https://github.com/LMU-GLP/2026-sdg-02) and click the
**Pull requests** tab.
...
**[github.com/LMU-GLP/2026-sdg-02/tree/main/wiki](https://github.com/LMU-GLP/2026-sdg-02/tree/main/wiki)**
...
**https://lmu-glp.github.io/2026-sdg-02/**
...
[your repo](https://github.com/LMU-GLP/2026-sdg-02) → **Pull requests** tab.
